...
Pod::Spec.new do |s|
    ...
    s.name         = "YJBannerView"
    s.version      = version
    s.summary      = "YJBannerView 是一款超级好用的 BannerView 控件, Author's email:houmanager@Hotmail.com 工作地点:BeiJing"
    s.description      = <<-DESC
                        YJBannerView 是一款超级好用的 BannerView 控件, Author's email:houmanager@Hotmail.com 工作地点:BeiJing. 欢迎一起交流.
                            DESC
